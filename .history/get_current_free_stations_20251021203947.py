...
# 充电站数据
charge_stations = [
    {"ck": "073515b94200", "name": "7号"},
    {"ck": "04021cd51a00", "name": "3号"},
    {"ck": "04015f9d0f00", "name": "4号"},
    {"ck": "04015c9f1900", "name": "5号"},
    {"ck": "04023ad93500", "name": "6号"},
    {"ck": "04023ada2100", "name": "8号"}
]
...
def main():
    ...
    for item in all_results:
        print(f"桩站: {item['station_name']}, 口号(SID): {item['sid']}, 剩余时间: {item['end_time_hms']}")
